...
#define report_error(args...) printf(args);
...
template<const int m, const int n, typename Tmat, typename Tvec>
__device__
int dsvd(Tmat &a, Tvec &w, Tmat &v)
{
    ...
    if (m < n) 
    {
        report_error("#rows must be > #cols \n");
        return(0);
    }
    ...
    {                             /* loop over singular values */
        ...
        {                         /* loop over allowed iterations */
            ...
            if (its >= 30) {
                report_error("No convergence after 30,000! iterations \n");
                return(0);
            }
